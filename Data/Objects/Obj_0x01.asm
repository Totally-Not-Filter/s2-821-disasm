...
; Offset_0x00FAF0:
		...
		jmp		(Debug_Mode).l				   ; Offset_0x02DE64
;-------------------------------------------------------------------------------
...
Sonic_Main:							   ; Offset_0x00FB14
		...
		move.w	#$003F, D2
Offset_0x00FB88:
		bsr.w	CopySonicMovesForMiles		   ; Offset_0x00FCD4
		move.w	#$0000, (A1, D0)
...
Offset_0x00FBE4:
		...
		bsr.w	CopySonicMovesForMiles		   ; Offset_0x00FCD4
		bsr.w	Sonic_Water					   ; Offset_0x00FCF8
...
Offset_0x00FC0C:
		bsr.w	Sonic_Animate				   ; Offset_0x010BF2
		tst.b	Obj_Timer(A0)					 ; $002A
		bmi.s	Offset_0x00FC1C
		jsr		(TouchResponse).l				   ; Offset_0x02B1EC
Offset_0x00FC1C:
		bra.w	Load_Sonic_Dynamic_PLC		   ; Offset_0x0110D4
;-------------------------------------------------------------------------------
...
CopySonicMovesForMiles:						   ; Offset_0x00FCD4
		...
		lea		($FFFFE400).w, A1
		move.w	(Control_Ports_Buffer_Data).w, (A1, D0)	 ; $FFFFF604
		rts
;-------------------------------------------------------------------------------
...
Offset_0x00FE2A:
		bsr.w	Sonic_Spindash				   ; Offset_0x01060E
		bsr.w	Sonic_Jump					   ; Offset_0x01051A
		bsr.w	Sonic_SlopeResist			   ; Offset_0x010726
		bsr.w	Sonic_Move					   ; Offset_0x00FEC6
		bsr.w	Sonic_Roll					   ; Offset_0x0104B4
		bsr.w	Sonic_LevelBoundaries		   ; Offset_0x010456
		jsr		(SpeedToPos).l				   ; Offset_0x00D1DA
		bsr.w	Player_AnglePos				   ; Offset_0x013694
		bsr.w	Sonic_SlopeRepel			   ; Offset_0x010798
Offset_0x00FE50:
		rts
;-------------------------------------------------------------------------------
Sonic_MdJump:						   ; Offset_0x00FE52
		bsr.w	Sonic_JumpHeight			   ; Offset_0x0105D2
		bsr.w	Sonic_ChgJumpDir			   ; Offset_0x0103CA
		bsr.w	Sonic_LevelBoundaries		   ; Offset_0x010456
...
Offset_0x00FE72:
		bsr.w	Sonic_JumpAngle				   ; Offset_0x0107DA
		bsr.w	Sonic_Floor					   ; Offset_0x01083A
		rts
;-------------------------------------------------------------------------------
Sonic_MdRoll:						   ; Offset_0x00FE7C
		bsr.w	Sonic_Jump					   ; Offset_0x01051A
		bsr.w	Sonic_RollRepel				   ; Offset_0x01075C
		bsr.w	Sonic_RollSpeed				   ; Offset_0x0102D4
		bsr.w	Sonic_LevelBoundaries		   ; Offset_0x010456
		jsr		(SpeedToPos).l				   ; Offset_0x00D1DA
		bsr.w	Player_AnglePos				   ; Offset_0x013694
		bsr.w	Sonic_SlopeRepel			   ; Offset_0x010798
...
Sonic_Move:							   ; Offset_0x00FEC6
		...
		bne.w	Offset_0x01013E
		tst.w	Obj_Player_Control(A0)					 ; $002E
		bne.w	Offset_0x010106
		btst	#$02, ($FFFFF602).w
		beq.s	Offset_0x00FEEE
		bsr.w	Offset_0x0101CE
Offset_0x00FEEE:
		btst	#$03, ($FFFFF602).w
		beq.s	Offset_0x00FEFA
		bsr.w	Offset_0x010254
Offset_0x00FEFA:
...
Offset_0x00FFF8:
		...
		subq.w	#$06, D3
		jsr		(Player_HitFloor_D3).l		   ; Offset_0x014164
		cmpi.w	#$000C, D1
		blt.w	Offset_0x010106
		move.b	#$0C, Obj_Ani_Number(A0)				 ; $001C
		bra.w	Offset_0x010106
...
Offset_0x010174:
		...
		add.b	D1, D0
		move.w	D0, -(A7)
		bsr.w	Player_WalkSpeed			   ; Offset_0x013FD8
		move.w	(A7)+, D0
		tst.w	D1
...
Sonic_RollSpeed:							   ; Offset_0x0102D4
		...
		move.w	#$0020, D4
		tst.b	(Player_Status_Flag).w				 ; $FFFFF7CA
		bne.w	Offset_0x01034E
		tst.w	Obj_Player_Control(A0)					 ; $002E
		bne.s	Offset_0x01030A
		btst	#$02, ($FFFFF602).w
		beq.s	Offset_0x0102FE
		bsr.w	Offset_0x010384
Offset_0x0102FE:
		btst	#$03, ($FFFFF602).w
		beq.s	Offset_0x01030A
		bsr.w	Offset_0x0103A8
Offset_0x01030A:
		move.w	Obj_Inertia(A0), D0				 ; $0014
...
Offset_0x010488:
		...
		rts
Offset_0x010498:
		bra.w	Kill_Sonic					   ; Offset_0x011128
Offset_0x01049C:
...
Offset_0x010852:
		...
		jsr		(CalcAngle).l					 ; Offset_0x00351A
		move.b	D0, Obj_Player_Status(A0)				 ; $002B
		subi.b	#$20, D0
		andi.b	#$C0, D0
		cmpi.b	#$40, D0
		beq.w	Offset_0x010926
		cmpi.b	#$80, D0
		beq.w	Offset_0x010988
		cmpi.b	#$C0, D0
		beq.w	Offset_0x0109E4
		bsr.w	Player_HitWall				   ; Offset_0x014468
		tst.w	D1
		bpl.s	Offset_0x01089A
		sub.w	D1, Obj_X(A0)					 ; $0008
		move.w	#$0000, Obj_Speed(A0)					 ; $0010
Offset_0x01089A:
		bsr.w	Offset_0x0142E6
		tst.w	D1
		bpl.s	Offset_0x0108AC
		add.w	D1, Obj_X(A0)					 ; $0008
		move.w	#$0000, Obj_Speed(A0)					 ; $0010
Offset_0x0108AC:
		bsr.w	Offset_0x0140A2
		tst.w	D1
...
Offset_0x010926:
		...
		rts
Offset_0x010940:
		bsr.w	Player_DontRunOnWalls		   ; Offset_0x014338
		tst.w	D1
...
Offset_0x010ACC:
		bsr.w	Sonic_HurtStop				   ; Offset_0x010AE6
		bsr.w	Sonic_LevelBoundaries		   ; Offset_0x010456
		bsr.w	CopySonicMovesForMiles		   ; Offset_0x00FCD4
		bsr.w	Sonic_Animate				   ; Offset_0x010BF2
		bsr.w	Load_Sonic_Dynamic_PLC		   ; Offset_0x0110D4
...
Sonic_Death:						   ; Offset_0x010B3E
		bsr.w	Sonic_GameOver				   ; Offset_0x010B5A
		jsr		(ObjectFall).l				   ; Offset_0x00D1AE
		bsr.w	CopySonicMovesForMiles		   ; Offset_0x00FCD4
		bsr.w	Sonic_Animate				   ; Offset_0x010BF2
		bsr.w	Load_Sonic_Dynamic_PLC		   ; Offset_0x0110D4
...
Sonic_Animate:						   ; Offset_0x010BF2
		lea		(Offset_0x010EB0).l, A1
		tst.b	(Super_Sonic_Flag).w				 ; $FFFFFE19
		beq.s	Offset_0x010C04
		lea		(Offset_0x011052).l, A1
Offset_0x010C04:
		moveq	#$00, D0
...
Offset_0x010C96:
		addq.b	#$01, D0
		bne.w	Offset_0x010E1E
		moveq	#$00, D0
		move.b	Obj_Flip_Angle(A0), D0					 ; $0027
		bne.w	Offset_0x010DB8
		moveq	#$00, D1
		move.b	Obj_Angle(A0), D0				 ; $0026
...
Offset_0x010CEA:
		...
		lea		(Offset_0x010EFA).l, A1
		cmpi.w	#$0600, D2
		bcc.s	Offset_0x010D04
		lea		(Offset_0x010EF0).l, A1
		add.b	D0, D0
Offset_0x010D04:
		add.b	D0, D0
		move.b	D0, D3
...
Offset_0x010D44:
		rts
Offset_0x010D46:
		lea		(Offset_0x01109C).l, A1
		cmpi.w	#$0800, D2
		bcc.s	Offset_0x010D5E
		lea		(Offset_0x011092).l, A1
		add.b	D0, D0
		add.b	D0, D0
...
Offset_0x010E1E:
		...
		neg.w	D2
Offset_0x010E32:
		lea		(Offset_0x010F0E).l, A1
		cmpi.w	#$0600, D2
		bcc.s	Offset_0x010E44
		lea		(Offset_0x010F04).l, A1
Offset_0x010E44:
		neg.w	D2
		addi.w	#$0400, D2
...
Offset_0x010E82:
		lsr.w	#$06, D2
		move.b	D2, Obj_Ani_Time(A0)					 ; $001E
		lea		(Offset_0x010F18).l, A1
		tst.b	(Super_Sonic_Flag).w				 ; $FFFFFE19
		beq.s	Offset_0x010E9A
		lea		(Offset_0x0110A6).l, A1
Offset_0x010E9A:
		move.b	Obj_Status(A0), D1				 ; $0022
		andi.b	#$01, D1
		andi.b	#$FC, Obj_Flags(A0)				 ; $0001
